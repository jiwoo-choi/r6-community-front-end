...
export function register( globalReactorList : Reactor<any,any,any>[] ){
...
export function getGlobalReactorWith( key : Reactor<any,any,any> | string , from : GlobalReactorType) {
